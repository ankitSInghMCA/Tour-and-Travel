...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const scriptURL =
    "https://script.google.com/macros/s/AKfycbzAfNADJfUlFiQ3AgZhs46emNC4VX0_ukWGAj9VNI5zHW9RIvoGh7TptJ8Ry0Q8F9Ij/exec"; // Replace with actual script URL
  ...
  return (
    <div>
      {/* Toast Container - Positioned at the top of component */}
      <ToastContainer
        position="top-right"
        autoClose={3000}
        hideProgressBar={false}
      ...
      <div className="container mt-5">
        ...
        <div className="accordion" id="faqAccordion">
          ...
          <div className="accordion-item mb-3 rounded border">
